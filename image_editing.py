...
def create_meme(curr_meme, meme_content, token):
    ...
    for WH, position in Memes[curr_meme].areas.items():
        font_size = 40  # Default value of font size
        ...
        width, height = WH[0], WH[1]  # Widht and height of the current content area
        ...
        text = meme_content[j]  # Getting content for the currrent content area
    ...
    # Create black border aroung text of the watermark
